...
if (isset($_GET['delete'])) {
    ...
    if ($has_students > 0) {
        $message = "Không thể xóa lớp vì có sinh viên đang học!";
    } else {
...
// Lấy danh sách lớp
$sql = "SELECT * FROM lop ORDER BY MALOP";
$stmt = $conn->prepare($sql);
$stmt->execute();
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 content">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2>Quản lý Lớp</h2>
                    <a href="themlop.php" class="btn btn-primary">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action-buttons">
                                            <a href="sualop.php?malop=<?php echo $class['MALOP']; ?>" class="btn btn-sm btn-warning">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="dslop.php?delete=<?php echo $class['MALOP']; ?>" 
