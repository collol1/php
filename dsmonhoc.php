...
if (isset($_GET['delete'])) {
    ...
    if ($has_results > 0) {
        $message = "Không thể xóa môn học vì có kết quả liên quan!";
    } else {
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 content">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="themmh.php" class="btn btn-primary">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action-buttons">
                                            <a href="suamh.php?mamh=<?php echo $subject['MAMH']; ?>" class="btn btn-sm btn-warning">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="dsmonhoc.php?delete=<?php echo $subject['MAMH']; ?>" 
